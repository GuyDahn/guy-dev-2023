  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Browse through Guy's latest articles on web development, React, JavaScript, and more."
        />
      </Head>
      <TransitionEffect />
      <main className="w-full mb-16 flex flex-col items-center justify-center overflow-hidden dark:text-light">
        <Layout className="pt-16">
          ...
          <ul className="grid grid-cols-2 gap-16 lg:gap-8 md:grid-cols-1 md:gap-y-16">
            <FeaturedArticle
              img={article1}
              title="Cloudflare’s Latest: A Developer’s All-You-Can-Build Bonanza"
              time="5 min read"
              summary="Cloudflare Pages, Workers, and Durable Objects are the latest tools in the Cloudflare ecosystem."
              link=""
            />
