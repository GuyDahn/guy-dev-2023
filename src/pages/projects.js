...
import project1 from '../../public/images/projects/vendup-1.png'
import project2 from '../../public/images/projects/rush-order-tees.png'
import project3 from '../../public/images/projects/bazelet.png'
          ...
          <div className='grid grid-cols-12 gap-24 gap-y-32 xl:gap-x-16 lg:gap-x-8 md:gap-y-24 sm:gap-x-0'>
            <div className='col-span-12'>
              <FeaturedProject
                ...
                title='Vendup'
                summary='Vendup is a web application that allows bussinesses to create an interactive catalogue, which serves as a self ordering app. It is built with React, Next.js, Tailwind CSS, and MongoDB.'
                img={project1}
                link='https://vendup.io'
